...
comment1 = Comment.create!(user_id: user2.id, artwork_id: artwork1.id, body: "Nice")
comment2 = Comment.create!(user_id: user1.id, artwork_id: artwork2.id, body: "Awesome")
comment3 = Comment.create!(user_id: user4.id, artwork_id: artwork4.id, body: "@guticode04 Thanks :)")
comment4 = Comment.create!(user_id: user3.id, artwork_id: artwork4.id, body: "Sick")
comment5 = Comment.create!(user_id: user5.id, artwork_id: artwork5.id, body: "Cool")
